    ...
    <div class="relative flex w-full max-w-xs flex-1 flex-col bg-white">
      ...
      <div class="h-0 flex-1 overflow-y-auto pt-5 pb-4">
        <div class="flex flex-shrink-0 items-center px-4">
          <img class="h-8 w-auto pr-3" src={logo} alt="polymath">polymath
        </div>
        <nav class="mt-5 space-y-1 px-2">
          ...
          <!-- <a href="/tokens" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
      ...
      <div class="flex flex-shrink-0 border-t border-gray-200 p-4">
        <a href="/" class="group block flex-shrink-0">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <p class="text-base font-medium text-gray-700 group-hover:text-gray-900">Jeffrey Brown</p>
  ...
  <div class="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
    <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
      ...
      <nav class="mt-5 flex-1 space-y-1 bg-white px-2">
        <a href="/" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {$page.route.id == '/' ? activePageStyles : inactivePageStyles}">
        ...
        <!-- <a href="/tokens" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {$page.route.id == '/tokens' ? activePageStyles : inactivePageStyles}">
          <svg class="mr-3 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
          </svg>
          Tokens
    ...
    <div class="flex flex-shrink-0 border-t border-gray-200 p-4">
      <a href="/" class="group block w-full flex-shrink-0">
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Jeffrey Brown</p>
