	...
	<main>
		<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <a href="/pathway/frontend" class="relative flex h-full flex-col rounded-md border border-gray-200 bg-white p-2.5 hover:border-gray-400 sm:rounded-lg sm:p-5"> 
						<span class="text-md mb-0 font-semibold text-gray-900 hover:text-black sm:mb-1.5 sm:text-xl"> Frontend Developer </span> 
						<span class="hidden text-sm leading-normal text-gray-400 sm:block">Step by step guide to becoming a modern frontend developer in 2023</span>
						<button aria-label="Add to favorites" tabindex="-1" class="opacity-30 hover:opacity-100 absolute right-8 top-1.5 z-30 focus:outline-0">
							<svg width="0" height="0" viewBox="0 0 20 20" fill="none" class="h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg">
