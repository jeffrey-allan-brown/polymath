<script>
  // core
  import Header from '../lib/components/_core/Header.svelte';
  import Sidebar from '../lib/components/_core/Sidebar.svelte';

  // ui
  import EmptyPathways from '../lib/components/_ui/EmptyPathways.svelte';
  import PageHeader from '../lib/components/_ui/PageHeader.svelte';
              ...
              <div class="sm:flex sm:items-baseline sm:justify-between">
                ...
                <div class="mt-4 flex items-center justify-between sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:justify-start">
                  ...
                  <div class="relative ml-3 inline-block text-left">
                    <div>
                      <button type="button" class="-my-2 flex items-center rounded-full bg-white p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500" id="menu-0-button" aria-expanded="false" aria-haspopup="true">
